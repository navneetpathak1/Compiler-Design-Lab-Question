...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* stmt: expr '\n'  */
#line 14 "expr_eval1.y"
                 { printf("Result = %d\n", yyvsp[-1]); }
#line 1118 "y.tab.c"
    break;

  case 3: /* expr: expr '+' expr  */
#line 17 "expr_eval1.y"
                       { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1124 "y.tab.c"
    break;

  case 4: /* expr: expr '-' expr  */
#line 18 "expr_eval1.y"
                       { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1130 "y.tab.c"
    break;

  case 5: /* expr: expr '*' expr  */
#line 19 "expr_eval1.y"
                       { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1136 "y.tab.c"
    break;

  case 6: /* expr: expr '/' expr  */
#line 20 "expr_eval1.y"
                       { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1142 "y.tab.c"
    break;

  case 7: /* expr: '(' expr ')'  */
#line 21 "expr_eval1.y"
                       { yyval = yyvsp[-1]; }
#line 1148 "y.tab.c"
    break;

  case 8: /* expr: NUM  */
#line 22 "expr_eval1.y"
                       { yyval = yyvsp[0]; }
#line 1154 "y.tab.c"
    break;
